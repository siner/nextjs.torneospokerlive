...
export default function RowTournamentV2(props) {
    ...
    return (
        <div
            className="flex flex-row w-full bg-base-100 base-content hover:bg-base-200 border-solid border shadow-sm"
            style={{
                opacity: opacity,
            }}
        >
            <div className="flex items-center justify-between flex-1 cursor-pointer select-none w-full">
                ...
                <div className="grow pl-1 mr-2 md:mr-5 p-2">
                    <div className="text-xs md:hidden mb-2">
                        {torneo.casino.name}
                    </div>
                ...
                <div className="w-40 pl-1 mr-2 md:mr-5 text-right p-2">
